...
export const FieldEditPassword = ({ onPasswordChange, onPasswordConfirmationChange }) => {
...
const handlePasswordConfirmationChange = (event) => {
    ...
    onPasswordConfirmationChange({ passwordConfirmation: newPasswordConfirmationChange });
};
return (
